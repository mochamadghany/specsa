...
export const defaultSiteContent: SiteContent = {
  ...
  pages: {
    ...
    layanan: {
      ...
      title: "Layanan teknis lengkap, dari konsultasi sampai aplikasi bergaransi.",
      lead:
        "Bukan sekadar supply material — kami dampingi engineering, fabrikasi, dan pemasangan membrane dengan dukungan software & garansi penuh.",
      heroImage: "/images/project-bkk.png",
      ctaLabel: "Konsultasi gratis sekarang",
      ctaHref: "/kontak",
      sections: [
        {
          title: "Layanan Specsa",
          body:
            "Setiap proyek didampingi tim teknis dengan jaminan material original, perhitungan akurat, dan aplikasi bergaransi.",
          items: [
            "Konsultasi gratis",
            "Jaminan material original dan bergaransi",
            "Jaminan aplikasi bergaransi, dilengkapi perhitungan dan dukungan software membrane serta software perhitungan baja",
            "Dukungan layanan shop drawing (gambar kerja) gratis",
            "Dukungan layanan perhitungan laporan struktur",
            "Dukungan alat bantu pekerjaan membrane di workshop",
            "Melayani project di seluruh Indonesia",
          ],
        },
        {
          title: "Alur Kerja",
          body:
            "Tim kami mengumpulkan kebutuhan, menyiapkan design & perhitungan, mengirim penawaran, lalu fabrikasi dan aplikasi di lapangan.",
          items: [
            "Brief kebutuhan & site survey",
            "Design, shop drawing & perhitungan struktur",
            "Penawaran dan konfirmasi PO",
            "Fabrikasi workshop & aplikasi bergaransi",
          ],
        },
      ],
      seo: {
